...
function Footer(){
    ...
    <div className="w-full max-w-screen-xl mx-auto p-4 md:py-8">
        ...
        <span className="block text-sm text-green-500 sm:text-center dark:text-green-400">© 2023 <a href="#" className="hover:underline">OrganiZapp</a>. All Rights Reserved.</span>
    </div>
</footer>
    )
}
