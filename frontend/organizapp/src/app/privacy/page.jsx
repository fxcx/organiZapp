...
export default function Privacy() {
  return (
      ...
      <>
        ...
        <div className="my-2">For the purposes of this Privacy Policy:</div>
        <ul className="list-disc">
          ...
          <li>
            <div className="my-2">
              <strong>Website:</strong> refers to organiZapp, accessible from{" "}
              <a
        ...
        <ul className="list-disc">
          ...
          <li className="font-bold">Twitter</li>
