      ...
      <div className="2xl:mx-auto 2xl:container 2xl:px-20 px-6 ">
        <div className="flex md:flex-row flex-col-reverse md:items-stretch items-center justify-center">
            ...
            <div className="flex flex-col items-center justify-center">
              ...
              <div className="md:mt-14 mt-12 flex flex-col items-center">
                ...
                <p className="text-base leading-6 mt-6 text-center text-gray-600 sm:w-96 w-full">
                  We want people to be organized and improve their quality of
                  time.
                </p>
              </div>
              <div className="mt-7 flex flex-col items-center">
                ...
                <p className="text-base leading-6 mt-6 text-center text-gray-600 sm:w-96 w-full">
                  You can contact us through the Contact tab
                </p>
              </div>
              <div className="mt-7 flex flex-col items-center">
                <div
                ...
                <p className="text-base leading-6 mt-6 text-center text-gray-600 sm:w-96 w-full">
                  We have a section to write in a group chat and also a calendar
                  to write down your needs!
                </p>
              </div>
              <div className="mt-7 flex flex-col items-center">
                <div
                ...
                <p className="text-base leading-6 mt-6 text-center text-gray-600 sm:w-96 w-full">
                  We do not seek to innovate, if we do not seek to improve the
                  basic things necessary to be able to organize better.
                </p>
              </div>
            </div>
          </div>
          <div className="py-12 xl:w-1/2 lg:w-1/3 sm:w-1/2">
            <Image
              src="https://img.eldefinido.cl/portadas/650/2015-03-10-7420LR8253.jpg"
